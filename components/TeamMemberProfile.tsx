...
const TeamMemberProfile: React.FC = () => {
  ...
  return (
    <section id="about" className="py-8 sm:py-12 relative bg-green-40 overflow-hidden">
      {/* Background */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="flex items-start justify-between mb-8">
              {/* William's Photo - positioned at top left */}
              <div className="mr-8 lg:mr-12 flex-shrink-0">
                <div className="w-48 h-48">
                  <img 
                    src="/william-mufuka.jpg.jpg" 
              ...
              <div className="flex-1">
                ...
                <div className="w-24 h-1 bg-[#5C2999] rounded-full mb-8"></div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5">
            ...
            <div className="bg-[#E4F5E1] rounded-xl p-6">
              <div className="text-center">
