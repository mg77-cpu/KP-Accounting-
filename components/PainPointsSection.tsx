...
const PainPointsSection: React.FC = () => {
  const painPoints = [
    ...
    },
    {
      ...
      solution: "We help you set up a system that allows you to put aside funds for tax and do regular check ins"
    },
    {
          ...
          {painPoints.map((point, index) => (
            <div key={index}>
              ...
              imageSrc={null}
                ...
                overlayContent={
                  <div className="bg-[#f8f9fa] rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300">
                    <div className="flex flex-col h-full">
                      <div className="mb-6">
                        <div className="w-12 h-12 bg-[#5C2999] bg-opacity-10 rounded-xl flex items-center justify-center mb-4">
